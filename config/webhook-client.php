...
return [
    'configs' => [
        ...
        [
            ...
            'signature_validator' => \App\Http\Webhooks\SignatureValidators\BulkVSSignatureValidator::class,

            /*
             * This class determines if the webhook call should be stored and processed.
             */
            'webhook_profile' => \App\Http\Webhooks\WebhookProfiles\BulkVSWebhookProfile::class,
             ...
             * This should be set to a class that extends \Spatie\WebhookClient\Jobs\ProcessWebhookJob.
             */
            'process_webhook_job' => \App\Http\Webhooks\Jobs\ProcessBulkVSWebhookJob::class,
        ],
        ...
        [
            ...
            'signature_validator' => \App\Http\Webhooks\SignatureValidators\VoipMsSignatureValidator::class,

            /*
             * This class determines if the webhook call should be stored and processed.
             */
            'webhook_profile' => \App\Http\Webhooks\WebhookProfiles\VoipMsWebhookProfile::class,
             ...
             * This should be set to a class that extends \Spatie\WebhookClient\Jobs\ProcessWebhookJob.
             */
            'process_webhook_job' => \App\Http\Webhooks\Jobs\ProcessVoipMsWebhookJob::class,
        ],
        ...
        [
            ...
            'signature_validator' => \App\Http\Webhooks\SignatureValidators\ApidazeSignatureValidator::class,

            /*
             * This class determines if the webhook call should be stored and processed.
             */
            'webhook_profile' => \App\Http\Webhooks\WebhookProfiles\ApidazeWebhookProfile::class,
             ...
             * This should be set to a class that extends \Spatie\WebhookClient\Jobs\ProcessWebhookJob.
             */
            'process_webhook_job' => \App\Http\Webhooks\Jobs\ProcessApidazeWebhookJob::class,
        ],
