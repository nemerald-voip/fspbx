...
class DatabaseSeeder extends Seeder
{
    ...
    private function createPermissions()
    {
        $permissions = [
            ...
            ['application_name' => 'AI Receptionists', 'permission_name' => 'ai_receptionist_view'],
            ['application_name' => 'AI Receptionists', 'permission_name' => 'ai_receptionist_add'],
            ['application_name' => 'AI Receptionists', 'permission_name' => 'ai_receptionist_edit'],
            ['application_name' => 'AI Receptionists', 'permission_name' => 'ai_receptionist_delete'],
            ['application_name' => 'AI Receptionists', 'permission_name' => 'ai_receptionist_all'],
            ['application_name' => 'AI Receptionists', 'permission_name' => 'ai_receptionist_tools'],
    ...
    private function createGroupPermissions()
    {
        $permissionsByGroup = [
            'superadmin' => [
                ...
                'ai_receptionist_view',
                'ai_receptionist_add',
                'ai_receptionist_edit',
                'ai_receptionist_delete',
                'ai_receptionist_all',
