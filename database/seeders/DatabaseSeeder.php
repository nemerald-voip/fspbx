...
class DatabaseSeeder extends Seeder
{
    ...
    private function createPermissions()
    {
        $permissions = [
            ...
            ['application_name' => 'Devices', 'permission_name' => 'device_template_dropdown_default'],
            ['application_name' => 'Devices', 'permission_name' => 'device_template_dropdown_custom'],
    ...
    private function createGroupPermissions()
    {
        $permissionsByGroup = [
            'superadmin' => [
                ...
                'location_delete',
                'device_key_advanced',
                'device_template_dropdown_default',
                'device_template_dropdown_custom',
