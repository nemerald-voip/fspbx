...
class DatabaseSeeder extends Seeder
{
    ...
    private function createPermissions()
    {
        $permissions = [
            ...
            ['application_name' => 'Extensions', 'permission_name' => 'extension_welcome_email_send'],
            ...
            ['application_name' => 'Devices', 'permission_name' => 'device_key_template_view'],
            ['application_name' => 'Devices', 'permission_name' => 'device_key_template_create'],
            ...
            ['application_name' => 'Phonebooks', 'permission_name' => 'phonebook_view'],
            ['application_name' => 'Phonebooks', 'permission_name' => 'phonebook_create'],
            ['application_name' => 'Phonebooks', 'permission_name' => 'phonebook_update'],
            ['application_name' => 'Phonebooks', 'permission_name' => 'phonebook_delete'],
            ['application_name' => 'Call Webhooks', 'permission_name' => 'call_webhook_view'],
            ['application_name' => 'Call Webhooks', 'permission_name' => 'call_webhook_create'],
            ['application_name' => 'Call Webhooks', 'permission_name' => 'call_webhook_update'],
            ['application_name' => 'Call Webhooks', 'permission_name' => 'call_webhook_delete'],
            ['application_name' => 'Call Webhooks', 'permission_name' => 'call_webhook_test'],
            ...
            ['application_name' => 'Email Templates', 'permission_name' => 'email_templates_view'],
            ['application_name' => 'Email Templates', 'permission_name' => 'email_templates_create'],
            ['application_name' => 'Email Templates', 'permission_name' => 'email_templates_update'],
            ['application_name' => 'Email Templates', 'permission_name' => 'email_templates_delete'],
            ['application_name' => 'Email Templates', 'permission_name' => 'email_templates_manage_global'],
            ['application_name' => 'Legacy Provision Templates', 'permission_name' => 'provision_editor_view'],
            ['application_name' => 'Legacy Provision Templates', 'permission_name' => 'provision_editor_save'],
    ...
    private function createGroupPermissions()
    {
        $permissionsByGroup = [
            'superadmin' => [
                ...
                'location_delete',
                'device_key_advanced',
                'device_key_template_view',
                'device_key_template_create',
                ...
                'email_templates_manage_global',
                'provision_editor_view',
                'provision_editor_save',
    ...
    private function createDefaultSettings()
    {
        $settings = [
            ...
            [
                'default_setting_category'      => 'provision',
                'default_setting_subcategory'   => 'yealink_t4_wallpaper',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "",
            ...
            [
                'default_setting_category'      => 'provision',
                'default_setting_subcategory'   => 'yealink_t4_wallpaper_filename',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "",
            ...
            [
                'default_setting_category'      => 'provision',
                'default_setting_subcategory'   => 'yealink_t5_wallpaper',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "",
            ...
            [
                'default_setting_category'      => 'provision',
                'default_setting_subcategory'   => 'yealink_t5_wallpaper_filename',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "",
            ...
            [
                'default_setting_category'      => 'provision',
                'default_setting_subcategory'   => 'yealink_t7_wallpaper',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "",
            ...
            [
                'default_setting_category'      => 'provision',
                'default_setting_subcategory'   => 'yealink_t7_wallpaper_filename',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "",
            ...
            [
                'default_setting_category'      => 'provision',
                'default_setting_subcategory'   => 'yealink_t8_wallpaper',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "",
            ...
            [
                'default_setting_category'      => 'provision',
                'default_setting_subcategory'   => 'yealink_t8_wallpaper_filename',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "",
            ...
            [
                'default_setting_category'      => 'scheduled_jobs',
                'default_setting_subcategory'   => 's3_upload_calls_time',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "01:00",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "Local time when the system uploads archived call recordings to S3 or compatible object storage. The time is interpreted using the Scheduled Jobs Timezone setting.",
            ],
            [
                'default_setting_category'      => 'scheduled_jobs',
                'default_setting_subcategory'   => 'backup_time',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "02:00",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "Local time when the system executes the daily server backup job. The time is interpreted using the Scheduled Jobs Timezone setting.",
            ],
            [
            ...
            [
                'default_setting_category'      => 'cloud_provision',
                'default_setting_subcategory'   => 'yealink_rps_access_key_id',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
                'default_setting_description'   => "Yealink RPS AccessKey ID",
            ],
            [
                'default_setting_category'      => 'cloud_provision',
                'default_setting_subcategory'   => 'yealink_rps_access_key_secret',
                'default_setting_name'          => 'text',
                'default_setting_value'         => "",
                'default_setting_enabled'       => true,
