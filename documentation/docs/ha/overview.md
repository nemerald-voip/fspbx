...
2. Set up **Postgres replication** (bi-directional). See: [Bi-Directional PostgreSQL Setup](/ha/postgres-replication.md).
3. Set up **Syncthing** with the FS PBX folders. See: [Syncthing File Replication](/ha/syncthing.md).
