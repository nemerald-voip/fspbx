...
{{-- ================= Algo 8301 algomMAC.cfg ================= --}}

admin.devname = sipalerter
admin.keyui = 1
admin.lang = en
admin.pwd = {{ $settings['admin_password'] ?? 'algo' }}
...
admin.teams.use = 0
admin.timezone = {{ $settings['algo_timezone'] ?? 'America/New_York' }}
admin.voice = en
admin.watchdog = 0
admin.web.api = 0
...
audio.page.vol = {{ $settings['algo_page_vol'] ?? '-18dB' }}
audio.port.input = 1
audio.relay.mode = 0
...
audio.ring.tone6 = Default
audio.ring.tone7 = Default
audio.ring.tone8 = Default
audio.ring.tone9 = Default
audio.ring.vol = {{ $settings['algo_ring_vol'] ?? '-18dB' }}
audio.rtp.media = 1
audio.spk.mode = 0
...
mcast.polycom.tone30 = None
mcast.polycom.tone31 = None
mcast.polycom.tone32 = None
mcast.polycom.tone33 = None
mcast.polycom.tone34 = None
mcast.polycom.tone35 = None
mcast.polycom.tone36 = None
mcast.polycom.tone37 = None
mcast.polycom.tone38 = None
mcast.polycom.tone39 = None
mcast.polycom.tone4 = None
mcast.polycom.tone40 = None
mcast.polycom.tone41 = None
mcast.polycom.tone42 = None
mcast.polycom.tone43 = None
mcast.polycom.tone44 = None
mcast.polycom.tone45 = None
mcast.polycom.tone46 = None
mcast.polycom.tone47 = None
mcast.polycom.tone48 = None
mcast.polycom.tone49 = None
mcast.polycom.tone5 = None
mcast.polycom.tone50 = None
...
net.srv.snmp.user = 
net.time = {{ $settings['ntp_server_primary'] ?? 'pool.ntp.org' }}
...
prov.download.cfgpath = prov
prov.download.fwpath = 
prov.download.method = https
prov.i = 1
prov.server.method = auto
prov.server.static = {{ trim(str_replace(['http://', 'https://', '/prov'], '', $settings['provision_base_url'] ?? ''), " /") }}
prov.auth.pwd = {{ $settings['http_auth_password'] ?? '0' }}
prov.auth.user = {{ $settings['http_auth_username'] ?? '0' }}
prov.sync.endtime =
...
sip.bkproxy1 = {{ $lines[1]['outbound_proxy_secondary'] ?? '' }}
sip.bkproxy2 = 
sip.detect.mode = 1
sip.diffport = 0
...
sip.nat.media = 
sip.outbound = 0
sip.obproxy = {{ $lines[1]['outbound_proxy_primary'] ?? '' }}
sip.page.use = 1
sip.proxy = {{ $lines[1]['server_address'] ?? ($lines[1]['server_address_primary'] ?? '') }}
sip.regexp = {{ $lines[1]['register_expires'] ?? '' }}
sip.register.use = 1
sip.registrar = 
sip.sips = 0
sip.srtp = 
...
sip.stun = 
sip.stun.server = 
sip.transp = {{ $lines[1]['sip_transport'] ?? 'udp' }}
sip.turn.pwd = 
sip.turn.server = 
sip.turn.user = 
sip.u1.auth = {{ $lines[1]['auth_id'] ?? '' }}
sip.u1.pwd = {{ $lines[1]['password'] ?? '' }}
sip.u1.user = {{ $lines[1]['auth_id'] ?? '' }}
synapps.port = 6789
synapps.server = 
synapps.use = 1
system.u1.pwd = algo
