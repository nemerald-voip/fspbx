...
admin.keyui = 1
admin.lang = en
admin.pwd = {{ $settings['admin_password'] ?? '' }}
...
audio.page.vol = {{ $settings['algo_page_vol'] ?? '' }}
audio.port.input = 1
audio.relay.mode = 0
...
audio.ring.vol = {{ $settings['algo_ring_vol'] ?? '' }}
audio.rtp.media = 1
audio.spk.mode = 0
...
net.srv.snmp.user = 
net.time = {{ $settings['ntp_server_primary'] ?? '' }}
prov.download.cfgpath = {{ $settings['provision_base_url'] ?? '' }}
prov.server.static = 
