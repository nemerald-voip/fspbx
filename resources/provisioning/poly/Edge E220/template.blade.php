...
<APPLICATION
    @if (array_key_exists('poly_e220_firmware', $settings) && $settings['poly_e220_firmware'] != '')
...
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<polycomConfig>
    <bg bg.color.bm.1.name="{{ $settings['poly_e220_wallpaper'] ?? ''}}" bg.color.selection="2,1" bg.logo="{{ $settings['poly_e220_logo'] ?? ''}}" />
</polycomConfig>
@break
