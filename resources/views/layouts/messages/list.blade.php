@extends('layouts.horizontal', ["page_title"=> "Messages"])
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Message Log</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                            ...
                            <tbody>
                                ...
                                @foreach ($messages as $message)
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input messageIdCheckbox" id="@php print 'messageCheck'.$i; @endphp" 
                                                    value="{{ $messages['message_uuid'] }}">
                                        ...
                                        <td>
                                            @if ($message['status'] == "success") 
                                                <h5><span class="badge bg-success"></i>{{ $message['status'] }}</span></h5>
                                            @else 
