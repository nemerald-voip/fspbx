                        ...
                        <!-- Body Content-->
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    @if ($voicemail->exists)
                                    <form method="POST" id="voicemail_form" action="{{ route('voicemails.update',$voicemail) }}">
                                    @method('put')
                                @else
                                        ...
                                        @if($voicemail->exists)
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input id="voicemail_name_upload_file" type="file" hidden data-url="{{ route("uploadVoicemailGreeting", $voicemail->voicemail_uuid) }}"/>
