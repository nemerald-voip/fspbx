            ...
            <div class="card mt-3">
                ...
                <!-- Body Content-->
                    <div class="row">
                        <div class="col-lg-12">
                            @if ($domain_group->exists)
                                <form method="POST" id="domain_group_form" action="{{ route('domaingroups.update',$domain_group) }}">
                                @method('put')
                            @else
                                <form method="POST" id="domain_group_form" action="{{ route('domaingroups.store') }}">
                            @endif
                            @csrf
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control"  type="text" value="{{ $domain_group->group_name }}" 
                                                    placeholder="Enter group name" id="group_name" name="group_name" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="domain_select" class="form-label">Assign domains to this group <span class="text-danger">*</label>
                                                <!-- Multiple Select -->
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="hidden" name="domain_group_uuid" value="{{ $domain_group->domain_group_uuid }}">
                                            {{-- <input type="hidden" name="contact_id" value="{{base64_encode($contact['contact_uuid'])}}"> --}}
                                                <a href="{{ Route('domaingroups.index') }}" class="btn btn-light me-2">Cancel</a>
