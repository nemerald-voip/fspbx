...
<div id="extensionUploadResultModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="extensionUploadResultModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="extensionUploadResultModalLabel">Extension Import</h4>
