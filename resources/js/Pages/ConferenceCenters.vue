    ...
    <div class="m-3">
        <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
            ...
            <template #table-header>
                ...
                <TableColumnHeader header="Greeting" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
                <TableColumnHeader header="PIN Length" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
            ...
            <template #table-body>
                <tr v-for="row in data.data" :key="row.conference_center_uuid">
                    <TableField class="whitespace-nowrap px-4 py-2 text-sm text-muted" :text="row.conference_center_name">
                        <div class="flex items-center">
                            <input v-model="selectedItems" type="checkbox" name="action_box[]"
                                :value="row.conference_center_uuid" class="h-4 w-4 rounded border-strong text-accent-fg">
                            <div class="ml-4"
                    ...
                    <TableField class="px-2 py-2 text-sm text-muted" :text="row.conference_center_description" />
