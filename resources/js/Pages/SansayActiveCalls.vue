        ...
        <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
            ...
            <template #action>
                ...
                <button type="button" @click.prevent="handleRefreshButtonClick()"
                    class="rounded-md bg-accent ml-2 px-2.5 py-1.5 text-sm font-semibold text-on-accent shadow-sm hover:bg-accent-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent">
                    Refresh
                </button>
            ...
            <template #table-header>
                ...
                <TableColumnHeader header="DNIS" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
                <TableColumnHeader header="ANI" class=" px-2 py-3.5 text-left text-sm font-semibold text-heading" />
                ...
                <TableColumnHeader header="Ans Time"
                    class="whitespace-nowrap px-2 py-3.5 text-left text-sm font-semibold text-heading" />
                <TableColumnHeader header="Duration" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
            ...
            <template #table-body>
                <tr v-for="row in data.data" :key="row.callID">
                    <TableField class="whitespace-nowrap px-4 py-2 text-sm text-muted ">
                        <div class="flex items-center">
                            <input v-if="row.callID" v-model="selectedItems" type="checkbox" name="action_box[]"
                                :value="row.callID" class="h-4 w-4 rounded border-strong text-accent-fg">
                            <div class="ml-9">
                                {{ row.orig_tid }}
                            </div>
                    ...
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.term_tid" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.dnis" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.ani" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.orig_ip" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.term_ip" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.inv_time" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.ans_time" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.duration_formatted" />
