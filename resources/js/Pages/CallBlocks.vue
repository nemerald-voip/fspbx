    ...
    <div class="m-3">
        <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
            ...
            <template #table-header>
                ...
                <TableColumnHeader header="Scope" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
                ...
                <TableColumnHeader header="Name" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
                <TableColumnHeader header="Count" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
            ...
            <template #table-body>
                <tr v-for="row in data.data" :key="row.call_block_uuid">
                    <TableField class="whitespace-nowrap px-4 py-2 text-sm text-muted">
                        <div class="flex items-center">
                            <input v-model="selectedItems" type="checkbox" name="action_box[]"
                                :value="row.call_block_uuid" class="h-4 w-4 rounded border-strong text-accent-fg">
                    ...
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="scopeLabel(row)" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="numberLabel(row)" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.call_block_name || '-'" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.call_block_count ?? 0" />
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="actionLabel(row)" />
                    ...
                    <TableField class="px-2 py-2 text-sm text-muted" :text="row.call_block_description" />
