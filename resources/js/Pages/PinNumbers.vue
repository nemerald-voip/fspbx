            ...
            <template #table-header>
                <TableColumnHeader class="px-4 py-3.5 text-left text-sm font-semibold text-heading">
                    <div class="flex items-center">
                        ...
                        <button class="flex items-center" :class="{ 'ml-4': hasSelectableActions }" @click="setSort('pin_number')">
                            ...
                            <ChevronUpIcon v-if="sortData.name === 'pin_number' && sortData.order === 'asc'" class="h-4 w-4 text-muted" />
                            <ChevronDownIcon v-else-if="sortData.name === 'pin_number' && sortData.order === 'desc'" class="h-4 w-4 text-muted" />
                        </button>
                    </div>
                </TableColumnHeader>
                <TableColumnHeader class="px-2 py-3.5 text-left text-sm font-semibold text-heading">
                    <button class="flex items-center" @click="setSort('accountcode')">
                        ...
                        <ChevronUpIcon v-if="sortData.name === 'accountcode' && sortData.order === 'asc'" class="h-4 w-4 text-muted" />
                        <ChevronDownIcon v-else-if="sortData.name === 'accountcode' && sortData.order === 'desc'" class="h-4 w-4 text-muted" />
                    </button>
                </TableColumnHeader>
                ...
                <TableColumnHeader class="px-2 py-3.5 text-left text-sm font-semibold text-heading">
                    <button class="flex items-center" @click="setSort('description')">
                        ...
                        <ChevronUpIcon v-if="sortData.name === 'description' && sortData.order === 'asc'" class="h-4 w-4 text-muted" />
                        <ChevronDownIcon v-else-if="sortData.name === 'description' && sortData.order === 'desc'" class="h-4 w-4 text-muted" />
                    </button>
                </TableColumnHeader>
