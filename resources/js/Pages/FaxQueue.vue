            ...
            <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
                ...
                <template #table-body>
                    <tr v-for="row in data.data" :key="row.fax_queue_uuid">
                        ...
                        <TableField class="whitespace-nowrap px-4 py-2 text-sm text-muted"
                            ...
                            <div class="flex items-center">
                                <input v-if="row.fax_queue_uuid" v-model="selectedItems" type="checkbox" name="action_box[]"
                                    :value="row.fax_queue_uuid" class="h-4 w-4 rounded border-strong text-accent-fg">
                                <div class="ml-9"
                                    :class="{ 'cursor-pointer hover:text-heading': page.props.auth.can.voicemail_update, }"
                        ...
                        <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.fax_number" />
                        ...
                        <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.fax_status">
                        ...
                        <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.fax_retry_count" />
                        <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted"
