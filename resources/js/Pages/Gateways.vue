    ...
    <div class="m-3">
        <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
            ...
            <template #table-header>
                ...
                <TableColumnHeader header="Proxy" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
                ...
                <TableColumnHeader header="Register" class="px-2 py-3.5 text-left text-sm font-semibold text-heading" />
            ...
            <template #table-body>
                <tr v-for="row in data.data" :key="row.gateway_uuid">
                    <TableField class="whitespace-nowrap px-4 py-2 text-sm text-muted" :text="row.gateway">
                        <div class="flex items-center">
                            <input v-model="selectedItems" type="checkbox" name="action_box[]"
                                :value="row.gateway_uuid" class="h-4 w-4 rounded border-strong text-accent-fg">
                    ...
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-muted" :text="row.proxy" />
