<template>
    ...
    <div class="m-3">
        <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
            <template #title>{{ $t('Registrations') }}</template>
            ...
            <template #table-header>
                ...
                <TableColumnHeader class="px-2 py-3.5 text-left text-sm font-semibold text-gray-900">
                    <div class="flex items-center cursor-pointer select-none" @click="handleSortRequest('expsecs')">
                        <span class="mr-2">{{ $t('Exp Sec') }}</span>
                ...
                <TableColumnHeader class="px-2 py-3.5 text-left text-sm font-semibold text-gray-900">
                    <div class="flex items-center cursor-pointer select-none" @click="handleSortRequest('sip_profile_name')">
                        <span class="mr-2">{{ $t('SIP Profile') }}</span>
                    ...
                    <TableField class="whitespace-nowrap px-2 py-1 text-sm text-gray-500">
                        <template #action-buttons>
                            <div class="flex items-center whitespace-nowrap">
                                <ejs-tooltip :content="$t('Restart')" position='TopCenter' target="#restart_tooltip_target">
                                ...
                                <ejs-tooltip :content="$t('Sync')" position='TopCenter' target="#sync_tooltip_target">
                                ...
                                <ejs-tooltip :content="$t('Unregister')" position='TopCenter'
...
const bulkActions = computed(() => [
    { id: 'bulk_restart', label: trans('Restart'), icon: 'RestartIcon' },
    { id: 'bulk_sync', label: trans('Sync'), icon: 'SyncIcon' },
    { id: 'bulk_unregister', label: trans('Unregister'), icon: 'LinkOffIcon' },
]);
...
const handleBulkActionRequest = (action) => {
    if (action === 'bulk_restart') {
        showConfirmation({
            text: trans('Restart the selected registration(s)?'),
            button: trans('Restart'),
    ...
    if (action === 'bulk_sync') {
        showConfirmation({
            text: trans('Sync the selected registration(s)?'),
            button: trans('Sync'),
    ...
    if (action === 'bulk_unregister') {
        showConfirmation({
            text: trans('Unregister the selected registration(s)?'),
            button: trans('Unregister'),
...
const showConfirmation = ({ text, button, action }) => {
    confirmationHeader.value = trans('Are you sure?');
