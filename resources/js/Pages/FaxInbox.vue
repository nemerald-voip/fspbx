            ...
            <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
                <template #title>
                    <h1 class="text-xl font-bold text-gray-900 flex items-center">
                        ...
                        <span class="font-medium text-gray-500">{{ props.fax_label ? $t(':name Inbox', { name: props.fax_label }) : $t("Fax Inbox") }}</span>
                    </h1>
                </template>
                ...
                <template #filters>
                    ...
                    <div class="relative z-10 min-w-64 -mt-0.5 mb-2 scale-y-95 shrink-0 sm:mr-4">
                        <DatePicker :dateRange="filterData.dateRange" :timezone="filterData.timezone" :clearable="false"
