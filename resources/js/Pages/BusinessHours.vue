        ...
        <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
            ...
            <template #table-body>
                <tr v-for="row in data.data" :key="row.uuid">
                    <TableField class="whitespace-nowrap px-4 py-2 text-sm text-muted" :text="row.extension">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4"
                                :class="{ 'cursor-pointer hover:text-heading': page.props.auth.can.business_hours_update, }"
