            ...
            <section class="min-w-0 flex-1">
                <div class="rounded-lg bg-white shadow-sm ring-1 ring-gray-200">
                    ...
                    <ul v-else-if="displayedRows.length" class="divide-y divide-gray-100">
                        <li v-for="row in displayedRows" :key="row.var_uuid" class="relative flex items-start gap-3 px-4 py-3 transition hover:bg-gray-50">
                            <input v-model="selectedItems" type="checkbox" :value="row.var_uuid" class="mt-1 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
