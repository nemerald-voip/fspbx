            ...
            <div v-if="activeTab === 'settings'">
                <div class="bg-surface-3 px-4 py-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-12">
                        <div class="rounded-md bg-info-subtle p-4">
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <InformationCircleIcon class="h-5 w-5 text-info" aria-hidden="true" />
                                </div>
                                <div class="ml-3">
                                    <p class="text-sm text-info">Select a new option to apply to all items, use the
                                        clear
                    ...
                    <div class="sm:col-span-12">
                        ...
                        <!-- <p class="mt-3 text-sm leading-6 text-body">Select a new common template for all selected devices</p> -->
                        <div v-if="errors?.device_template" class="mt-2 text-sm text-danger">
                    ...
                    <div v-if="page.props.auth.can.domain_select && page.props.auth.can.device_edit_domain"
                        ...
                        <div v-if="errors?.domain_uuid" class="mt-2 text-sm text-danger">
            ...
            <div v-if="activeTab === 'lines'">
                <div class="shadow sm:rounded-md">
                    <div class="space-y-6 bg-surface-3 px-4 py-6 sm:p-6">
                        <div>
                            <h3 class="text-base font-semibold leading-6 text-heading">Line Keys</h3>
                            <div class="rounded-md bg-warning-subtle p-4">
                                <div class="flex">
                                    <div class="flex-shrink-0">
                                        <ExclamationTriangleIcon class="h-5 w-5 text-warning" aria-hidden="true" />
                                    </div>
                                    <div class="ml-3">
                                        <h3 class="text-sm font-medium text-warning">Attention needed</h3>
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <template v-for="(row, index) in form.lines" :key="row.device_line_uuid">
                                ...
                                <div class="col-span-3 text-sm font-medium leading-6 text-heading">
                                ...
                                <div class="col-span-4 text-sm font-medium leading-6 text-heading">
                                    ...
                                    <Menu as="div" class="relative inline-block text-left">
                                        <div>
                                            <MenuButton
                                                ...
                                                <EllipsisVerticalIcon class="h-9 w-9 transition duration-500 ease-in-out py-2 rounded-full text-muted hover:bg-surface-3 hover:text-heading active:bg-surface-3 active:duration-150 cursor-pointer" aria-hidden="true" />
                                            </MenuButton>
                                        </div>
                                        ...
                                        <transition enter-active-class="transition ease-out duration-100"
                                            ...
                                            <MenuItems
                                                class="absolute right-0 z-10 mt-2 w-36 origin-top-right rounded-md bg-surface shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                <div class="py-1">
                        ...
                        <div
                            class="flex justify-center bg-surface-3 px-4 py-4 text-center text-sm font-medium text-accent-fg hover:text-accent-fg sm:rounded-b-lg">
