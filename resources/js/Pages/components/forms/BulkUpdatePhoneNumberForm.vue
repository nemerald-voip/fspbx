                                    ...
                                    <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
                                        <div class="px-2 py-6 sm:px-6 lg:col-span-3 lg:px-0 lg:py-0">
                                            <FormTabs view="vertical" @select="handleTabSelected">
                                                <FormTab name="page0" label="Settings" :elements="[
                                                    ...
                                                    'destination_enabled',
                                                    'destination_prefix_checkbox',
                                                    'destination_prefix',
                                                    'destination_number_checkbox',
                                                    'destination_number',
                                                    'destination_description',
                                                    'destination_description_checkbox',
                                                    'routing_container',
                                                    'call_routing_title',
                                                    'routing_options_checkbox',
                                                    'routing_options',
                                                    'container_3',
                                                    'submit',
                                                ...
                                                <FormTab name="page1" label="Advanced" :elements="[
                                                    ...
                                                    'fax_uuid_checkbox',
                                                    'fax_uuid',
                                                    'destination_cid_name_prefix_checkbox',
                                                    'destination_cid_name_prefix',
                                                    'destination_accountcode_checkbox',
                                                    'destination_accountcode',
                                                    'destination_distinctive_ring_checkbox',
                                        ...
                                        <div
                                            ...
                                            <FormElements>
                                                ...
                                                <!-- <CheckboxElement name="destination_prefix_checkbox" :submit="false"
                                                    label="&nbsp;" :columns="{
                                                        container: 1,
                                                    }" />
                                                ...
                                                <TextElement name="destination_prefix" label="Country Code"
                                                    ...
                                                    }" :disabled="[['destination_prefix_checkbox', false]]" />

                                                <CheckboxElement name="destination_number_checkbox" :submit="false"
                                                    label="&nbsp;" :columns="{
                                                        container: 1,
                                                    }" />
                                                ...
                                                }" :disabled="[['destination_number_checkbox', false]]" /> -->

                                                <CheckboxElement name="destination_description_checkbox" :submit="false"
                                                    label="&nbsp;" :columns="{
                                                        container: 1,
                                                    }" />
                                                ...
                                                <CheckboxElement name="routing_options_checkbox" :submit="false"
                                                    label="&nbsp;" :columns="{
                                                        container: 1,
                                                    }" @change="(newValue, oldValue, el$) => {
                                                        if (newValue == false) {
                                                            el$.form$.el$('routing_options').hide()
                                                        } else {
                                                            el$.form$.el$('routing_options').show()
                                                        }
                                                    }" />
                                                ...
                                                <ListElement name="routing_options" :sort="true" size="sm"
                                                    :disabled="[['routing_options_checkbox', false]]"
                                                    :controls="{ add: true, remove: true, sort: true }" @mounted="(el$) => {
                                                        el$.form$.el$('routing_options').hide()
                                                    }"
                                                ...
                                                <CheckboxElement name="destination_type_fax_checkbox" :submit="false"
                                                    :conditions="[() => options?.permissions?.manage_recording_setting]"
                                                    :columns="{
                                                        container: 1,
                                                    }" />
                                                ...
                                                <CheckboxElement name="fax_uuid_checkbox" :submit="false" label="&nbsp;"
                                                    :columns="{
                                                        container: 1,
                                                    }" />
                                                ...
                                                <CheckboxElement name="destination_cid_name_prefix_checkbox"
                                                ...
                                                <CheckboxElement name="destination_accountcode_checkbox" :submit="false"
                                                    label="&nbsp;" :columns="{
                                                        container: 1,
                                                    }" />
                                                ...
                                                <CheckboxElement name="destination_distinctive_ring_checkbox"
                                                    :submit="false" label="&nbsp;" :columns="{
                                                        container: 1,
                                                    }" />
