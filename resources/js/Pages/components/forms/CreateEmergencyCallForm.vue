<template>
    <div class="bg-white px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                <LabelInputRequired target="members" label="Members (Extensions)" />
                <div class="mt-2 relative">
                    <!-- <ComboBox :options="options.extensions" :selectedItem="form.members" :search="true" :multiple="true"
                        placeholder="Choose Extensions" @update:model-value="handleUpdateMembers"
                        :error="errors?.members && errors.members.length > 0" /> -->
