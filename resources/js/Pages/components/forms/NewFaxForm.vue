                            ...
                            <Vueform v-if="!loading" ref="form$" :endpoint="submitForm" @success="handleSuccess"
                                ...
                                <MultifileElement name="files" label="Upload files" :upload-temp-endpoint="false"
                                    ...
                                    accept=".pdf,.doc,.docx,.rtf,.xls,.xlsx,.csv,.txt,.jpeg,.jpg" :rules="[
                                        ...
                                        MultifileElement: {
                                            listItem: '!bg-teal-50 dark:bg-teal-900/40 !border !border-teal-200 dark:border-teal-700 rounded-md !p-2 mt-2 shadow-sm !text-teal-700 dark:text-teal-300 font-semibold [&_.form-bg-passive]:!bg-teal-200 dark:[&_.form-bg-passive]:!bg-teal-800 hover:[&_.form-bg-passive]:!bg-teal-300 dark:hover:[&_.form-bg-passive]:!bg-teal-300 [&_.form-bg-passive>span]:!bg-teal-800 dark:[&_.form-bg-passive>span]:!bg-teal-800'
                                        }
                                    }" />
