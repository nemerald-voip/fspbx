                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <Vueform :validate-on="''" v-if="!loading" ref="form$" :endpoint="submitForm" @success="handleSuccess"
                                ...
                                <StaticElement name="h4" tag="h4" :content="$t('Create New Domain Group')" />
                                <TextElement name="group_name" :label="$t('Name')" :placeholder="$t('Enter Group Name')"
                                    :floating="false" />


                                <TagsElement name="members" :close-on-select="false" :search="true" :items="options.domains"
                                    :label="$t('Members')" input-type="search" autocomplete="off" :strict="false"
                                    :placeholder="$t('Select Members')" :floating="false" />
