    ...
    <div class="bg-surface px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                ...
                <div v-if="errors?.emergency_number" class="mt-2 text-xs text-danger">
            ...
            <div>
                ...
                <div v-if="errors?.members" class="mt-2 text-xs text-danger">
                    {{ errors.members[0] }}
                </div>
            </div>
            ...
            <div>
                ...
                <textarea v-model="form.emails" rows="3"
                    ...
                    class="mt-2 block w-full rounded-md border-strong shadow-sm focus:border-info focus:ring-focus sm:text-sm"></textarea>
                <div v-if="errors?.emails" class="mt-2 text-xs text-danger">
                    {{ errors.emails[0] }}
                </div>
            </div>
            ...
            <div class="border-t mt-4">
                <div class="mt-4 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                    <button @click.prevent="submitForm"
                        class="inline-flex w-full justify-center rounded-md bg-accent px-3 py-2 text-sm font-semibold text-on-accent shadow-sm hover:bg-accent-hover sm:col-start-2"
