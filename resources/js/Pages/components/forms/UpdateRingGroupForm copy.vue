                    ...
                    <div class="space-y-6 bg-gray-50 px-4 py-6 sm:p-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3 text-sm font-medium leading-6 text-gray-900">
                                ...
                                <div class="mt-2 relative">
                                    <VueMultiselect v-model="form.greeting" :options="localOptions.greetings"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3 text-sm font-medium leading-6 text-gray-900">
                                ...
                                <div class="mt-2 relative">
                                    <VueMultiselect v-model="form.ring_pattern" :options="localOptions.ring_patterns"
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="flex flex-wrap items-end gap-6">
                                    ...
                                    <div class="flex-1 relative">
                                        <!-- <MultiselectElement name="members" v-model="selectedNewMembers" :native="false"
                                                :groups="true" :items="availableMembers" group-label="groupLabel"
                                                group-options="groupOptions" track-by="label"  :floating="false" :hide-selected="false" :close-on-select="false"
                                                placeholder="Search by name or extension" multiple :search="true" /> -->


                                        <Vueform>
                                            <TagsElement name="members" v-model="selectedNewMembers" :native="false"
                                                :groups="true" :items="availableMembers" group-label="groupLabel"
                                                group-options="groupOptions" track-by="label" :floating="false"
                                                :hide-selected="false" :close-on-select="false"
                                                placeholder="Search by name or extension" multiple :search="true"
                                                label="Add Member(s)" />
                                    ...
                                    <Vueform>
                                        <ButtonElement name="add" button-label="Add" button-type="button" secondary
                                            :disabled="!selectedNewMembers.length" @click="addSelectedMembers" />
                                    </Vueform>
