                    ...
                    <div class="space-y-6 bg-gray-100 px-4 py-6 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3 space-y-3">
                                <LabelInputOptional label="Date" class="truncate" />
                                <VueDatePicker v-model="date" :range="false"
                                    :enable-time-picker="false"  :min-date="new Date()" auto-apply
                                    @update:model-value="handleDate" :timezone="timezone" placeholder="Select Date">
                                </VueDatePicker>
                            </div>

                            <div class="sm:col-span-3 space-y-3">
                                <LabelInputOptional label="Time" class="truncate" />
                                <VueDatePicker v-model="time" time-picker
                                    :min-date="new Date()" auto-apply :is-24="false"
                                    @update:model-value="handleDate" :timezone="timezone" placeholder="Select Time">
                                </VueDatePicker>
                            </div>
