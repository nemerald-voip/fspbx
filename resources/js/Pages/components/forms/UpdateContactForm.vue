                    ...
                    <div class="space-y-6 bg-gray-100 px-4 py-6 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="col-span-3 sm:col-span-3">
                                ...
                                <InputField v-model="form.contact_organization" type="text" name="contact_organization" id="contact_organization"
                                    class="mt-2" :error="!!errors?.contact_organization" />
                            ...
                            <div class="col-span-3 sm:col-span-3">
                                <LabelInputRequired target="destination_number" label="Destination Number" class="truncate" />
                                <InputField v-model="form.destination_number" type="text" name="destination_number" id="destination_number"
                                    class="mt-2" :error="!!errors?.destination_number" />
                    ...
                    <div class="space-y-6 bg-gray-100 px-4 py-6 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="col-span-6 sm:col-span-3 space-y-3">
                                ...
                                <ComboBox :options="options.users" :selectedItem="options.contact.user_uuid" :search="true"
                                    placeholder="Choose Assigned User" @update:model-value="handleUserUpdate"
