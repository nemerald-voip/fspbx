        ...
        <form @submit.prevent="submitForm" class="sm:px-6 lg:col-span-9 lg:px-0">
            <div v-if="activeTab === 'license'">
                <div class="space-y-6 bg-gray-100 px-4 py-6 sm:p-6">
                    ...
                    <div v-if="props.options.item.license" class="mt-2 border-t border-gray-100">
                        <dl class="divide-y divide-gray-100">
                            ...
                            <div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                ...
                                <dd class="mt-1 flex text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    <span v-if="props.options.item.license_details?.data?.id" class="flex-grow text-green-600">License key is valid</span>
                            ...
                            <div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                ...
                                <dd class="mt-1 flex text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    <span v-if="props.options.item.license_details?.data && !props.options.item.license_details?.data?.attributes?.suspended" class="flex-grow text-green-600">No</span>
                                    <!-- <span v-if="props.options.item.license_details?.data?.attributes?.suspended" class="flex-grow text-green-600">No</span> -->
                                    <span v-if="props.options.item.license_details?.data && props.options.item.license_details?.data?.attributes?.suspended" class="flex-grow text-rose-600">Yes</span>
                                    <!-- <span class="ml-4 flex-shrink-0">
                                        <button type="button"
                            ...
                            <div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                ...
                                <dd class="mt-1 flex text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    <div>
                                        <span v-if="props.options.item.license_details?.data?.attributes?.expiry" class="flex-grow"> {{ props.options.item.license_details?.data?.attributes?.expiry }}</span>
                                        <span v-if="props.options.item.license_details?.meta?.code == 'EXPIRED'" class="ml-3 flex-grow text-rose-600"> Expired</span>
                                    </div>
                            ...
                            <div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                ...
                                <dd class="mt-1 flex text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    ...
                                    <span v-if="props.options.item.license_details?.meta?.code == 'VALID'" class="flex-grow text-green-600">The license key is activated</span>
                                    <span v-else class="flex-grow text-rose-600"></span>

                                    <span v-if="props.options.item.license_details?.meta?.code == 'NO_MACHINE'" class="ml-4 flex-shrink-0">
                                    ...
                                    <span v-if="props.options.item.license_details?.meta?.code == 'VALID'" class="ml-4 flex-shrink-0">
                    ...
                    <div v-if="!props.options.item.license" class="bg-gray-100  px-4 py-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
