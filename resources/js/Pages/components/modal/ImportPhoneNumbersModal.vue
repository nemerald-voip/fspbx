                    ...
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div v-if="loading" class="flex justify-center items-center p-10">
                                <svg class="animate-spin h-8 w-8 text-info" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                            ...
                            <div v-else class="w-full">
                                <Vueform ref="form$" :endpoint="false" :display-errors="false" :default="{ items: importData }">
                                    ...
                                    <StaticElement name="bulk_header" tag="h4" content="Bulk Apply" class="text-sm font-semibold text-body mb-2 mt-2" />
                                    
                                    <GroupElement name="bulk_group" :columns="{ lg: 12, md: 12, sm: 12 }" class="bg-surface-2 p-4 rounded-lg border border-default mb-6 flex items-start">
                                            ...
                                            <template #default>
                                                <div class="pt-[26px]">
                                                    <button type="button" @click.prevent="handleBulkApply"
                                                        class="w-full whitespace-nowrap inline-flex justify-center rounded-md bg-accent px-3 py-[9px] text-sm font-semibold text-on-accent shadow-sm hover:bg-accent-hover disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent">
                                                        Apply to All
                                                    </button>
                                                </div>
                                            </template>
                                    ...
                                    <StaticElement name="table_header_row">
                                        <template #default>
                                            <div class="hidden lg:grid grid-cols-12 gap-4 px-2 py-2 bg-surface border-b border-default text-xs font-bold text-muted uppercase tracking-wider mb-2">
                                ...
                                <div class="mt-6 flex justify-end gap-3 border-t pt-4 bg-surface">
                                    <button type="button" 
                                    ...
                                    <button type="button" 
                                        class="rounded-md bg-success-solid px-3 py-2 text-sm font-semibold text-on-accent shadow-sm hover:bg-success-solid-hover disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-success"
