                    ...
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <Vueform v-if="!loading" ref="form$" :endpoint="submitForm" @success="handleSuccess"
                                ...
                                <StaticElement name="h4" tag="h4" :content="$t('Create Multiple Hotel Rooms')" />


                                <TagsElement name="extensions" :close-on-select="false" :search="true" :items="options.extensions" 
                                :label="$t('Choose Extensions to Assign to Rooms')" input-type="search" autocomplete="off" />
                                ...
                                <ButtonElement name="submit" :button-label="$t('Add Rooms')" :submits="true" align="right"
                                    :columns="{
                                        container: 6,
                                    }" />
                            </Vueform>
