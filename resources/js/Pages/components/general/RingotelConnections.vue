                    ...
                    <table class="min-w-full divide-y divide-strong">
                        ...
                        <tbody class="divide-y divide-default">
                            ...
                            <tr v-if="connections.length === 0">
                                <td colspan="6" class="py-4 text-center text-sm italic text-muted">
                            ...
                            <tr v-for="(option, index) in connections" :key="index">
                                ...
                                <td class="px-3 py-4 text-sm text-muted">{{ option.domain }}</td>
                                            ...
                                            <MenuItems
                                                ...
                                                <div class="py-1">
                                                    ...
                                                    <a href="#" @click.prevent="handleEdit(option)"
                                                        :class="[active ? 'bg-surface-3 text-heading' : 'text-body', 'block px-4 py-2 text-sm']">Edit</a>
                                                    </MenuItem>
                                                    <MenuItem v-slot="{ active }">
