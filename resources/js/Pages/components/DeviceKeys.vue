            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <div class="overflow-hidden border-t border-default">
                    <table class="min-w-full divide-y divide-default mb-4">
                        ...
                        <tbody v-if="!loading && keys.length" class="divide-y divide-default bg-surface">
                            <tr v-for="device in keys" :key="key.line_number">
                                <!-- Device MAC Address -->
                    ...
                    <!-- Empty State -->
                    <div v-if="!loading && keys.length === 0" class="text-center my-5">
