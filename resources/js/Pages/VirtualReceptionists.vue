<template>
    ...
    <div class="m-3">
        <DataTable @search-action="handleSearchButtonClick" @reset-filters="handleFiltersReset">
            <template #title>{{ $t('Virtual Receptionists') }}</template>
            ...
            <template #table-header>
                <TableColumnHeader
                    ...
                    <div class="pl-4 flex items-center cursor-pointer select-none" @click="handleSortRequest('ivr_menu_name')">
                        <span class="mr-2">{{ $t('Virtual Receptionist') }}</span>
            ...
            <template #table-body>
                <tr v-for="row in data.data" :key="row.ivr_menu_uuid">
                    ...
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-gray-500" :text="row.ivr_menu_enabled">
                        <Badge v-if="row.ivr_menu_enabled == 'true'" :text="$t('Enabled')" backgroundColor="bg-green-50"
                    ...
                    <TableField class="whitespace-nowrap px-2 py-1 text-sm text-gray-500">
                        <template #action-buttons>
                            <div class="flex items-center whitespace-nowrap justify-end">
                                <ejs-tooltip v-if="permissions.virtual_receptionist_update" :content="$t('Edit')"
                                ...
                                <ejs-tooltip v-if="permissions.virtual_receptionist_destroy" :content="$t('Delete')"
