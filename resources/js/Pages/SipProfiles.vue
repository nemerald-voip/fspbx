<template>
    ...
    <div class="m-3">
        <DataTable @search-action="fetchData(1)" @reset-filters="resetFilters">
            ...
            <template #subtitle>
                Manage Sofia SIP profiles, domains, and profile parameters.
            </template>
            ...
            <template #table-header>
                ...
                <TableColumnHeader header="Rows" class="px-2 py-3.5 text-left text-sm font-semibold text-gray-900" />
                ...
                <tr v-for="row in data.data" :key="row.sip_profile_uuid">
                    <TableField class="px-4 py-2 text-sm text-gray-500">
                        <div class="flex items-center">
                            ...
                            >
                                ...
                                <span class="mt-1 block truncate text-xs text-gray-400">{{ row.sip_profile_uuid }}</span>
                            </button>
                        </div>
                    </TableField>

                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-gray-500">
                        {{ row.sip_profile_hostname || "Default switch" }}
                    </TableField>
                    ...
                    <TableField class="whitespace-nowrap px-2 py-2 text-sm text-gray-500">
                        <div class="flex flex-wrap gap-1.5">
                            ...
                            <Badge :text="`${row.domains_count} domains`" v-bind="countBadge" />
                        </div>
                    </TableField>
