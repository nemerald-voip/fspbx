          ...
          <div class="flex items-center gap-x-4 sm:gap-x-6">
            ...
            <div class="mx-auto max-w-8xl px-4 py-10 sm:px-6 lg:px-8">
                <div
                    ...
                    <!-- Quick Access -->
                    <div
                        class="-mx-4 px-4 py-8 shadow-sm bg-gray-50 ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pb-20 xl:pt-16">
                            ...
                            <tbody>
                                <tr v-for="item in invoice.items" :key="item.id" class="border-b border-gray-100">
                                    ...
                                    <td
                                        class="hidden py-5 pl-8 pr-0 text-right align-top tabular-nums text-gray-700 sm:table-cell">
                                        {{ item.rate }}</td>
                                    <td class="py-5 pl-8 pr-0 text-right align-top tabular-nums text-gray-700">{{ item.price
                                    }}</td>
                                </tr>
                            </tbody>
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="pb-0 pl-8 pr-0 pt-4 text-right tabular-nums text-gray-900">{{ invoice.tax }}
                                    </td>
                                </tr>
                                <tr>
